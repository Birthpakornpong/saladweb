<template>
  <article class="post single">
    ...
    <div class="post-body">
      ...
      <div class="post-meta">
        <a href="javascript:;" class="hash-scroll"
      ...
      <div class="post-content" v-if="isContent">
        ...
        <p>
          ...
          Nam vel dui eget justo dictum pretium a rhoncus ipsum. Donec venenatis
          erat tincidunt nunc suscipit, sit amet bibendum lacus posuere. Sed
          scelerisque, dolor a pharetra sodales, mi augue consequat sapien, et
          interdum tellus leo et nunc. Nunc imperdiet eu libero ut imperdiet.
        </p>
      </div>
      ...
      <div class="post-share">
        ...
        <div class="social-icons">
          ...
          <a href="javascript:;" class="social-icon social-mail" title="Email">
