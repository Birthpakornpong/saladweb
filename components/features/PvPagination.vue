<template>
  <ul class="pagination toolbox-item mb-0" v-if="pageNumbers.length > 1">
    <li class="page-item" v-if="currentPage > 1">
      <nuxt-link class="page-link page-link-btn" :to="prevPage">
    ...
    <li class="page-item" v-if="currentPage < totalPage">
      <nuxt-link class="page-link page-link-btn" :to="nextPage">
